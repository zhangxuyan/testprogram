...
//        content.put(contentKey,contentValue+"\n--------\n"+df.format(new Date()));
    ...
    */
    public String post(String charset, String contentType, String url,
        ...
        String resp;//https://api.weixin.qq.com/cgi-bin/message/send?access_token=11_1XB9Lm5srAMB0UVpVccOQT2qRjRZTnmetMTG8kU8T83MxTSAy5N1F-jmp7_yy7ZU49rjc8J9E7Z7qXHZ8nB0XHie16VvdP_RAnIKGiPmgu5ZWWK2phajutpkS9S-8B_9rzdvTohCxT9C2jnUJIBhACAQPI
        try {//https://api.weixin.qq.com/cgi-bin/message/custom/send?access_token=ACCESS_TOKEN
            HttpEntity entity = response.getEntity();
        ...
        LoggerFactory.getLogger(getClass()).info( url, data, resp);//( "call [{}], param:{}, resp:{}", url, data, resp);
        return resp;
    }
