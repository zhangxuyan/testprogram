...
public class Application {
	private static SessionFactory sessionFactory = new Configuration() //
			.configure() //
			.addClass(Department.class) // 添加Hibernate实体类（加载对应的映射文件）相当于再hibernate.cfg.xml中配置了映射文件
			.addClass(Employee.class) // 添加Hibernate实体类（加载对应的映射文件）相当于再hibernate.cfg.xml中配置了映射文件
			.buildSessionFactory();
